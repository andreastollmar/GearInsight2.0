    ...
    public class Character
    {
        ...
        public static async Task<Character> FetchCharacterAsync(string character, string realm) //ändra till entrys
        {
            ...
            if (stats.Success)
            {
                ...
                //c.Leech.Rating = Helpers.ExtractRatingFromStats(stats.Value.Lifesteal.ToString());
                //c.Leech.Percent = Helpers.ExtractPercentFromStats(stats.Value.Lifesteal.ToString());

                //c.Speed.Rating = Helpers.ExtractRatingFromStats(stats.Value.Speed.ToString());
                //c.Speed.Percent = Helpers.ExtractPercentFromStats(stats.Value.Speed.ToString());

                //c.Avoidance.Rating = Helpers.ExtractRatingFromStats(stats.Value.Avoidance.ToString());
                //c.Avoidance.Percent = Helpers.ExtractPercentFromStats(stats.Value.Avoidance.ToString());
